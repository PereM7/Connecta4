...
/*
private int haConnectatHoritzontal (char[][] matriu) {
    ...
    private int haConnectat (char[][] matriu) {

        if (haConnectatHoritzontal(matriu) != -1) {
            return haConnectatHoritzontal(matriu);
        }
        else if (haConnectatVertical(matriu) != -1) {
            return haConnectatVertical(matriu);
        }
